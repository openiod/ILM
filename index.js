	...
	streamCsvHistoryFile: function (url, fileName, unzip, desc) {
		...
		function createCql(inpFile) {
			...
			for(i=1;i<tmpArray.length-1;i++) {  // start i=1 !!
				...
				VALUES( 2a1c1d09-c044-447c-9346-1b40692c59e6, 'ILM', d46a9592-3f38-436c-9e94-4e82d0f798b3, '25.cal', 'P1-25-10-UOHT', '"+ _dataRecord.phenomenonTime + "', '4326', "+ _dataRecord.lat + ", " + _dataRecord.lng + ", " + " 'active', " +					
